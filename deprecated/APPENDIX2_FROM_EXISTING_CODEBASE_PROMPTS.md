...
This step acknowledges that codebase might have undocumented/unsurfaced concepts (architectural intents, edge cases, thinking of future scalability or security) whicih was only documented as a code
...
### Phase 5: Detailing Existing concepts 
...
1. Scan the project structure:
   ...
   - Locate existing documentation and read them too but not trust them yet.  
   - Find configuration files and understand what is configurable and how, dont forget to cross check with actual implmenetation
   
2. Create devdocs/archaeology/initial_survey.md documenting:
   - Project size and scope
   - Technologies discovered

3. Create devdocs/archaeology/existing_architecture.md documenting:
   - what kind of high level architecture exists, explained in terms of modules/concepts and how they are connected
4. Create devdocs/archaeology/existing_design_level_conventions.md documenting:
   - What kind of repeated pattern exists in the code base in terms of that might be design convention (high level only)
5. Create devdocs/archaeology/existing_design_level_conventions.md documenting:

The point of analyzing is:
    - Understand the 
